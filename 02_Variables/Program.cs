...
namespace _02_Variables_
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.Write("Lütfen aldığınız bilgisayar adetinizi giriniz:");
            //computerCount= int.Parse(Console.ReadLine());

            //Console.Write("Lütfen aldığınız sandalye adetinizi giriniz:");
            //chairCount = int.Parse(Console.ReadLine());

            //Console.Write("Lütfen aldığınız televizyon adetinizi giriniz:");
            ...
            #region Klavyeden Karakter Girişkeri
